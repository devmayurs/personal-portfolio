...
const HeroSection: React.FC = () => {
  ...
  return (
    <Box
      ...
      aria-label="About Mayur Solanki"
    >
      ...
      <Container maxWidth="xl">
        <Box className="hero-section__inner">
          ...
          <Box className="hero-section__text">
            <Typography
              variant="overline"
              className="hero-section__tag fu"
            >
            ...
            <Typography
              component="h1"
              className="hero-section__name fu2"
            >
              Mayur
              <br />
            ...
            <Typography variant="body1" className="hero-section__bio fu3">
              I build enterprise-grade software — CRM, ERP, POS, B2B eCommerce — with architectural depth
              that goes beyond standard development. I own migrations, architect Nx Monorepo systems, design
              reusable framework ecosystems, and ship CI/CD pipelines on GCP. My skills span frontend
              architecture, schema-driven platforms, AI automation, and cloud deployments —{' '}
            ...
            <Stack direction="row" gap="1rem" flexWrap="wrap" className="fu4">
              <Button
                variant="contained"
                onClick={() => scrollTo(ESection.PROJECTS)}
              ...
              <Button
                variant="outlined"
                onClick={() => scrollTo(ESection.CONTACT)}
