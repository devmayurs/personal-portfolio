      ...
      <Container maxWidth="xl">
        ...
        <Box className="skills-section__callout">
          <Typography variant="body2" className="skills-section__callout-text">
            ...
            architectural ownership of Nx Monorepo migrations, Micro Frontend systems, reusable framework
            design, schema-driven platforms, AI workflow automation, and full CI/CD cloud pipelines across
            GCP, Vercel and Render.
          </Typography>
        </Box>
        ...
        <Box className="skills-section__arch-bar">
          ...
          <Stack direction="row" flexWrap="wrap" gap="0.75rem">
